...
**Date: 2026-09-09 | 74 engines live | 225/225 tests green | engine count is dynamic (see `--list-venues` and the GUI header, rendered from the registry)**
...
| 320 failure patterns | 320 | ~262+ templates across 74 engines | **82%+** (remainder = API/ML/human) |
