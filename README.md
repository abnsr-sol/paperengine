...
76 engines incl. deterministic p-value verification (statcheck) · dual
...
**76 specialized engines** against your manuscript and returns every finding as:
...
The file is parsed in memory, checked by the same 76 engines as the CLI, and
...
└── checks/            76 engines — one per rejection angle
