...
94 engines incl. deterministic p-value verification (statcheck) · dual
...
[![Tests](https://img.shields.io/badge/tests-292%20passing-brightgreen)](#development)
...
**94 specialized engines** against your manuscript and returns every finding as:
...
The file is parsed in memory, checked by the same 94 engines as the CLI, and
...
└── checks/            94 engines — one per rejection angle
